...
do for [i=1:words(DIST_SQ_THRESHOLDS)] {
  ...
  if (1) {
    set label sprintf("%s %s", d, in_fn_size) at graph 0.01,0.05
  }
  ...
  plot \
  in_fn u 2:1 with filledcurves lw 1 fs transparent solid 0.5 border lc rgb "#808080" fc rgb "#FFFFFF" not
}
